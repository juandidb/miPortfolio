        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                    Developer & IT Support Professional
                  </p>
                </div>
              </div>
              
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Building reliable, maintainable applications with clean architecture 
                and exceptional user experiences. Passionate about solving complex 
            ...
            <motion.div variants={itemVariants}>
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4">
                  {[
                    { label: 'Years Experience', value: '5+', color: 'from-blue-500 to-cyan-500' },
                    { label: 'Projects Completed', value: '50+', color: 'from-green-500 to-emerald-500' },
                    { label: 'Client Satisfaction', value: '100%', color: 'from-purple-500 to-pink-500' },
                    { label: 'Response Time', value: '< 24h', color: 'from-orange-500 to-red-500' }
                  ].map((stat, index) => (
          ...
          <div className="pt-8 border-t border-gray-200 dark:border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              >
                <span>© {currentYear} Juan Di Benedetto. All rights reserved.</span>
